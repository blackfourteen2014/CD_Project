  ...
  return (
    <>
      <Sider style={{ background: "dark" }}>
        ...
        <Row>
          <Col span={12}>
            <Button block onClick={handleOnWork} className="sidebar_btn">
              출근
            </Button>
          </Col>
          <Col span={12}>
            <Button block onClick={handleOffWork} className="sidebar_btn">
              퇴근
            </Button>
          </Col>
        </Row>
        ...
        <OffWork
          ...
          Date={Date}
          Time={Time}
          handleOffOk={handleOffOk}
        />
        <Menu
          theme="dark"
          defaultSelectedKeys={props.DefaultKey}
          mode="inline"
          id="sideBar_employee_menu"
        >
