...
export function HolidayDataRead() {
  const request = axios
    .get("/api/system/holidaydataread")
...
export function HolidayCreate(dataToSubmit) {
  const request = axios
    .post("/api/system/holidaycreate", dataToSubmit)
    .then((response) => response.data);
...
export function HolidayDelete(dataToSubmit) {
  const request = axios
    .post("/api/system/holidaydelete", dataToSubmit)
    .then((response) => response.data);
...
export function HolyCodeListRead() {
  const request = axios
    .get("/api/system/holycodelistread")
    .then((response) => response.data);
...
export function SmallCodeCreate(dataToSubmit) {
  const request = axios
    .post("/api/system/smallcodecreate", dataToSubmit)
    .then((response) => response.data);
...
export function SmallCodeDelete(dataToSubmit) {
  const request = axios
    .post("/api/system/smallcodedelete", dataToSubmit)
    .then((response) => response.data);
...
export function MasterCodeSearchListRead(dataToSubmit) {
  const request = axios
    .post("/api/system/mastercodesearchlistread", dataToSubmit)
    .then((response) => response.data);
...
export function MasterCodeCreate(dataToSubmit) {
  const request = axios
    .post("/api/system/mastercodecreate", dataToSubmit)
    .then((response) => response.data);
...
export function MasterCodeDelete(dataToSubmit) {
  const request = axios
    .post("/api/system/mastercodedelete", dataToSubmit)
    .then((response) => response.data);
...
export function UserCreate(dataToSubmit) {
  const request = axios
    .post("/api/system/create", dataToSubmit)
    .then((response) => response.data);
...
export function UserUpdate(dataToSubmit) {
  const request = axios
    .post("/api/system/update", dataToSubmit)
    .then((response) => response.data);
...
export function UserDelete(dataToSubmit) {
  const request = axios
    .post("/api/system/delete", dataToSubmit)
    .then((response) => response.data);
