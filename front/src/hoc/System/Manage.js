...
function Manage() {
  ...
  useEffect(() => {
    //직원 데이터 Read
    dispatch(UserRead()).then((response) => {
  ...
  const handleDelete = () => {
    //유저 데이터 Delete
    dispatch(UserDelete(CheckTarget)).then((response) => {
      ...
      <Layout style={{ minHeight: "100vh" }}>
        ...
        <Layout style={{ backgroundColor: "white" }}>
          <div style={{ textAlignLast: "end", background: "#fff", padding: 0 }}>
            <Link to="/">
              <Button style={{ marginRight: "1%", marginTop: "10px" }}>
                로그아웃
              </Button>
            </Link>
          </div>
          ...
          <Content>
            ...
            <div style={{ fontSize: 20, background: "#fff", minHeight: 2 }}>
              ...
              <div
                style={{ background: "#fff", minHeight: 20, textAlign: "end" }}
              >
